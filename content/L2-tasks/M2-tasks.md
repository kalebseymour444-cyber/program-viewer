...
| `M2.2.1` | OSP route engineering to carrier POP / meet point | DOC | `ICT` | 10d | `M2.1.2` | — | 223d | `NOT_STARTED` |
...
| `M2.2.5` | OTDR testing end-to-end, both paths | DIG | `ICT` | 3d | `M2.2.4` | `M2.2.6` | 61d | `NOT_STARTED` |
| `M2.2.6` | 🚨 Physical diversity verification — field walk, not paperwork | PHY | `NET-R` | 2d | `M2.2.5` | — | 61d | `NOT_STARTED` |
...
| `M2.4.4` | Grounding & bonding verified | PHY | `ICT` | 2d | `M2.4.3` | — | 56d | `NOT_STARTED` |
...
| `M2.7.1` | OOB carrier selection — different carrier, different path | DOC | `NET-R` | 5d | `M2.3.1` | `M2.7.2` | 84d | `NOT_STARTED` |
| `M2.7.2` | OOB circuit provisioned _(external)_ | DOC | `NET-R` | 30–90d | `M2.7.1` | `M2.7.3` | 84d | `NOT_STARTED` |
| `M2.7.3` | OOB terminal server / console infrastructure install | PHY | `NET-F` | 3d | `M2.7.2` | `M2.7.4` | 84d | `NOT_STARTED` |
| `M2.7.4` | 🚨 OOB reachability proven with primary path down | DIG | `NET-R` | 1d | `M2.7.3` | `M2.8.4`, `M5.4.3` | 84d | `NOT_STARTED` |
...
| `M2.8.4` | 🚨 WAN acceptance signed | DOC | `NET-R` | 1d | `M2.8.3`, `M2.7.4` | `M7.7.1` | 0d | `NOT_STARTED` |
